...
import { ICommand, Identifier, IEvent, ISaga, TSagaConstructorParams } from "./interfaces";
...
export default class AbstractSaga implements ISaga {
	 ...
	 */
	constructor(options: TSagaConstructorParams) {
		/* istanbul ignore if */
	 ...
	 */
	protected enqueue(commandType: string, aggregateId: Identifier, payload: object) {
		/* istanbul ignore if */
