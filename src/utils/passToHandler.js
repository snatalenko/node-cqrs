...
/**
 * Validates whether a specific object can handle messageType and invokes
 * a corresponding message handler ('_' + messageType)
 *
 * @param {Object} context
 * @param {String} messageType
 * @param {...args} message handler arguments
 * @returns {*} result of the handler invokation
 */
